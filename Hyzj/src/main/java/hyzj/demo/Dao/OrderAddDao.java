...
public interface OrderAddDao {
     ...
     * @return
     */
    @Insert("insert into order_add(Add_record,C_id,number,single_people,single_phone,add_time,add_describe," +
            "price) values(#{0},#{3},#{4},#{1},#{2},#{6},#{7},#{5})")
     ...
     * @return
     */
    @Update("update order_add set Add_record = #{0},single_people = #{1},single_phone = #{2}," +
            "C_id = #{3},number = #{4},price = #{5},add_time = #{6},add_describe = #{7}")

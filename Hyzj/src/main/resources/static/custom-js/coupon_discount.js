...
$(document).ready(function(){
    ...
    $("#btn_add_save").click(function(e){
        ...
        if (params.discount > 10 || params.discount < 0 || params.discount == ""){
            swal({
                title: "折扣在1 - 10折之间！",
                text: "",
                type: "warning",
        ...
        if(params.cid == '' || params.discount == '' || params.strat == '' ||
    ...
    table.on('click', '.edit', function (e) {
        ...
        $('#coupon_edit_discount').val(aData[1]);
    ...
    $("#btn_edit_save").click(function(e){
        ...
        params.discount =$('#coupon_edit_discount').val();
        ...
        console.log(JSON.stringify(params,null,4));
        if(params.cid == '' || params.discount=='' || params.condition=='' || params.end <= params.strat){
            swal({
